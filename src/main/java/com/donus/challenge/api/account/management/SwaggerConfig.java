package com.donus.challenge.api.account.management;
	...
	@Bean
    	public Docket productApi() {
        	return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.donus.challenge.api.account.management"))
                .paths(regex("/banking-system.*"))
                .build()
                .apiInfo(metaInfo());
    	}
		...
		ApiInfo apiInfo = new ApiInfo(
                "Grenciamento de contas bancárias",
